...
if ./reqtrace.native extract --strip=_build/ ${outdir}/example_bad.cmt ; then
...
./reqtrace.native extract --strip=_build/ --rfc mdns=6762 --rfc edns0=2671 ${outdir}/example_cstruct.cmt
