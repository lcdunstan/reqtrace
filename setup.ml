...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4bf86a5328efd95911c77c55ce20c6fc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/infidel/reqtrace";
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_reqtrace.ml"});
               Executable
                 ({
                     cs_name = "reqtrace";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "reqtrace.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "ppx_reqtrace"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\"2 \t\243\251\183\195\012\164\170i\233\174J\226";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
